...
class AuthenticationApi {
  ...
  Future<Response<UserEntity>> authControllerGetCurrentUser({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LoginEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginEntity>> authControllerLogin({ 
    ...
    LoginEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(LoginEntity),
      ) as LoginEntity;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignupEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SignupEntity>> authControllerRegister({ 
    ...
    SignupEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SignupEntity),
      ) as SignupEntity;
